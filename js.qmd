...
## Prerequisites 
This tutorial provides an introduction to JS, and no previous knowledge of JS is required. We will use some basic HTML and CSS throughout the tutorial, don't worry if you are unfamiliar with those languages. 
